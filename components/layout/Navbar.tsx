...
const navItems = [
  { name: "Home", href: "/" },
  {
    name: "About", href: "/about", dropdown: [
      { name: "About Cambridge International School", href: "/about" },
...
const announcements = [
  ...
  "Cambridge International School wins State-level inter-school debate championship",
];

const schools = [
  "Cambridge International School (Cambridge), Jawahar Nagar, Jaipur",
];
    ...
    <>
      ...
      <div className="fixed left-3 sm:left-6 bottom-5 sm:bottom-8 z-[110] flex flex-col items-start gap-2 sm:gap-3">
        <a
          ...
          aria-label="Call Cambridge International School"
        >
        ...
        <a
          ...
          aria-label="Message Cambridge International School on WhatsApp"
        >
