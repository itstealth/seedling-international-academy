...
const stats = [
  ...
  },
  {
    ...
    description: "A global community of Seedling International School graduates",
  ...
  },
  {
    ...
    description: "Seedling International School alumni span the globe",
...
const achievements = [
  ...
  },
  {
    ...
    body: "At Seedling International School, we prioritize the holistic well-being of our students, parents, and staff — nurturing academic, emotional, social, and physical growth.",
    icon: "💚",
  ...
  return (
    <section className="pt-8 pb-10 bg-white">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        <div className="rounded-3xl overflow-hidden shadow-xl grid md:grid-cols-2 bg-[#d4f4ed]">
          <div className="relative min-h-[420px] md:min-h-[560px] overflow-hidden group">
            ...
            <div className="absolute top-6 left-6">
              <span className="bg-sand text-[#133844] text-[10px] font-black uppercase tracking-[0.2em] px-4 py-1.5 rounded-full font-dm">
                The Pride of Seedling International School
              </span>
            </div>
          </div>

          <div className="flex flex-col justify-center p-10 md:p-14 text-[#133844]">
            <p className="text-[#133844] text-[10px] font-black uppercase tracking-[0.2em] mb-4 font-dm">
              Seedling International School Alumni
            </p>

            <h2 className="font-playfair text-4xl md:text-5xl font-bold mb-2 leading-tight text-[#133844]">
              Harshil Mathur
            </h2>
            <p className="font-playfair text-xl text-[#133844] font-medium mb-8">
              CEO, Razorpay
            </p>

            <blockquote className="relative">
              <div className="text-7xl text-[#133844]/20 font-playfair absolute -top-4 -left-2 leading-none select-none">
                "
              </div>
              <p className="text-[#133844]/80 text-lg leading-relaxed pl-4 border-l-2 border-[#133844]/50 font-dm font-light">
                ...
                gain insights into how  Seedling International School played a pivotal role in shaping
                their path to success.
              </p>
            </blockquote>

            <div className="mt-10 flex items-center gap-4">
              <div className="w-12 h-px bg-[#133844]/30" />
              <span className="text-[#133844]/40 text-[10px] font-black uppercase tracking-[0.2em] font-dm">
            ...
            <div className="mt-8 flex flex-wrap gap-2">
              {["Entrepreneurship", "Fintech", "Leadership", "Innovation"].map((tag) => (
                <span
                  key={tag}
                  className="text-[10px] font-black tracking-widest uppercase bg-white/10 border border-[#133844]/10 text-[#133844] px-3 py-1 rounded-full font-dm"
                >
                  {tag}
                </span>
              ))}
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-text-light max-w-xl mx-auto text-lg font-dm font-light">
            ...
            each carrying the Seedling International School spirit forward.
          </p>
        </div>
...
function AlumniNetwork() {
  ...
  return (
    <section className="pt-8 pb-16 bg-[#d4f4ed] relative overflow-hidden">
      ...
      >
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 mb-4">
            <div className="w-8 h-px bg-sand" />
            <span className="text-[10px] font-black text-[#133844] uppercase tracking-[0.3em] font-dm">
              Stay Connected
            </span>
            <div className="w-8 h-px bg-sand" />
          </div>
          <h2 className="font-playfair text-4xl md:text-5xl font-bold text-[#133844] mb-4">
            Nurture the Network!
          </h2>
          <p className="text-[#133844]/60 max-w-xl mx-auto text-lg font-dm font-light">
            The Seedling International School Tribe with its Happy Vibe — a community that extends far
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {networkCards.map((card, i) => (
            <div
              key={card.title}
              className="group rounded-2xl bg-white/5 hover:bg-white/10 border border-[#133844]/10 hover:border-sand/30 p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-sand/5"
            ...
            >
              ...
              <h3 className="font-playfair text-xl font-bold text-[#133844] mb-3">{card.title}</h3>
              <p className="text-[#133844]/60 text-sm leading-relaxed mb-6 font-dm font-light">{card.body}</p>
              <button className="text-[#133844] text-[10px] font-black tracking-widest uppercase group-hover:underline flex items-center gap-2 font-dm">
                {card.cta}
      ...
      <div className="max-w-6xl mx-auto px-6 mb-12">
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <p className="text-text-light max-w-xs text-sm leading-relaxed font-dm font-light">
            Voices from our vibrant student community — each one a growing Seedling International School story.
          </p>
        </div>
      </div>
  ...
  return (
    <section className="pt-10 pb-10 bg-white">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        >
          <div className="absolute inset-0 bg-[#d4f4ed]" />
          ...
          <div className="relative z-10 text-center py-20 px-8">
            <div className="inline-flex items-center gap-2 bg-white/10 border border-[#133844]/20 rounded-full px-5 py-2 mb-8">
              <span className="w-2 h-2 bg-sand rounded-full animate-pulse" />
              <span className="text-[#133844] text-[10px] font-black uppercase tracking-[0.3em] font-dm">
                Admissions Open 2026–27
              </span>
            </div>

            <h2 className="font-playfair text-4xl md:text-6xl font-bold text-[#133844] mb-6 leading-tight">
              Join the Seedling International School{" "}
            ...
            <p className="text-[#133844]/80 text-lg md:text-xl max-w-2xl mx-auto mb-12 leading-relaxed font-dm font-light">
              Be part of a global community that celebrates growth, resilience,
              and collaboration. Connect with your alma mater — Seedling International School Group.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                className="bg-sand text-[#133844] font-black px-8 py-4 rounded-full shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200 text-[11px] uppercase tracking-widest font-dm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-transparent text-[#133844] border-2 border-[#133844]/30 font-black px-8 py-4 rounded-full hover:bg-white/10 hover:-translate-y-0.5 transition-all duration-200 text-[11px] uppercase tracking-widest font-dm"
              >
                Enquire Now
              </a>
            </div>

            <div className="mt-16 flex flex-wrap justify-center gap-8 text-[#133844]/50 text-[10px] font-black tracking-widest uppercase font-dm">
...
export const metadata = {
  title: "Alumni | Seedling International School Group",
  description:
