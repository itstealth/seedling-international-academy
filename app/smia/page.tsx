          ...
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.4 }} transition={{ duration: 0.45, ease: EASE }}>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                ...
                <a href="tel:+919587772837" className="text-navy-deeper font-semibold hover:text-crimson transition-colors">+91 95877 72837 (Admissions)</a>
              </div>
              <div className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-full bg-crimson text-white flex items-center justify-center flex-shrink-0 text-[10px]">✉</span>
            ...
            <a href="https://maps.google.com/?q=Seedling+Modern+International+Academy+Durgapura+Jaipur" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 mt-6 text-[11px] font-black tracking-[0.2em] uppercase text-crimson hover:text-navy-deeper transition-colors">
              View on Google Maps
