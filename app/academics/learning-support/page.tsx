    ...
    <div className="bg-neutral-bg min-h-screen pt-32 overflow-x-hidden">
      ...
      <section className="py-48 px-4 sm:px-6 lg:px-8 max-w-[1200px] mx-auto text-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className="text-label mb-8 block uppercase tracking-[0.5em]">The Seedling International School Ecosystem</span>
          ...
          <p className="text-2xl text-neutral-600 font-medium leading-relaxed max-w-3xl mx-auto">
            At Seedling International School, learning support is not just about academic remediation; it&apos;s about building a holistic world where students feel safe, understood, and inspired to grow.
          </p>
        </motion.div>
      </section>
            ...
            >
              ...
              <div className="flex-1 space-y-12">
                <div className="relative">
                  ...
                  <h3 className="text-heading text-4xl md:text-5xl mb-8">{system.title}</h3>
      ...
      <section className="py-64 bg-primary text-white text-center relative overflow-hidden rounded-[6rem] mx-4 md:mx-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-label text-white opacity-60 uppercase tracking-[0.5em] block">The Seedling International School Philosophy</span>
          </div>
        </div>
      </section>
