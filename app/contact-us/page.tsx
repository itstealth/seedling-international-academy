...
function InfoCard({
  ...
  return (
    <div className="group bg-blue-100 rounded-2xl p-6 shadow-sm border border-blue-700 transition-all duration-200 hover:shadow-xl hover:-translate-y-0.5">
  ...
  return (
    <main className="min-h-screen bg-off-white font-dm">
      ...
      {/* ══════════════════════════════════════════════════════════════════════
          CONTACT FORM
      ══════════════════════════════════════════════════════════════════════ */}
      <section id="contact-form" className="pt-12 pb-8 md:pt-16 md:pb-10 bg-blue-100 border-y border-blue-700 scroll-mt-6">
        <div className="max-w-6xl mx-auto px-6">
            ...
            <div>
              ...
              <ul className="space-y-3 mb-10">
                {[
                  ...
                  'Cambridge Board programmes available',
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            ...
            <div className="md:col-span-2">
              <div className="bg-blue-100 rounded-2xl border border-blue-700 overflow-hidden mb-5">
