...
const sections = [
  ...
  },
  {
    ...
    icon: Globe,
    content: `While Seedling International School Group endeavors to keep the website accessible at all times, it reserves the right to suspend, restrict, or withdraw access to the website (in whole or in part) at any time without notice for operational, security, or administrative reasons.`
  },
  {
    title: "Disclaimer",
    icon: AlertTriangle,
  ...
  },
  {
    ...
    icon: Shield,
    content: `Any dealings or communications between Seedling International School Group and students or prospective students do not create a legal or contractual relationship with parents, guardians, sponsors, or other third parties. Use of the online prospectus and website content is subject to these Terms and Conditions.`
  },
  {
    title: "Copyright",
    icon: FileText,
    content: `All content on this website, including text, images, logos, and design, is protected by copyright and other intellectual property laws. Content may be viewed, printed, or downloaded solely for personal and non-commercial use. No material may be copied, modified, reproduced, published, or distributed without prior written permission from Seedling International School Group.\n\nThe name, logo, and trademarks of Seedling International School Group may not be used without express written authorization from the School.`
  },
  {
    title: "Complaints",
    icon: AlertTriangle,
          ...
          <div className="space-y-6">
            {sections.map((section, index) => (
              <motion.div
                ...
                className={`bg-pathway-rose-bg rounded-2xl shadow-md overflow-hidden border ${section.isLast ? 'border-pathway-rose-border bg-crimson/5' : 'border-pathway-rose-border'}`}
              >
