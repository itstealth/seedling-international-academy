...
const sections = [
  {
    title: "Privacy Policy of Seedling International Academy",
    icon: Shield,
...
Seedling International Academy, Jaipur

Email: seedlingacademy@hotmail.com

Website: https://cambridge.seedlingschools.com/
          ...
          <div className="space-y-6">
            {sections.map((section, index) => (
              <motion.div
                ...
                className={`bg-blue-100 rounded-2xl shadow-md overflow-hidden border ${section.isLast ? 'border-blue-700 bg-crimson/5' : 'border-blue-700'}`}
              >
