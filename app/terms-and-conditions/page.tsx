...
const sections = [
  ...
  { id: "s5", title: "5. Website Availability", content: "While Cambridge International School Group endeavors to keep the website accessible at all times, it reserves the right to suspend, restrict, or withdraw access to the website (in whole or in part) at any time without notice for operational, security, or administrative reasons." },
  ...
  { id: "s7", title: "7. No Liability to Third Parties", content: "Any dealings or communications between Cambridge International School Group and students or prospective students do not create a legal or contractual relationship with parents, guardians, sponsors, or other third parties. Use of the online prospectus and website content is subject to these Terms and Conditions." },
  { id: "s8", title: "8. Copyright", content: "All content on this website, including text, images, logos, and design, is protected by copyright and other intellectual property laws. Content may be viewed, printed, or downloaded solely for personal and non-commercial use. No material may be copied, modified, reproduced, published, or distributed without prior written permission from Cambridge International School Group.", callout: "The name, logo, and trademarks of Cambridge International School Group may not be used without express written authorization from the School." },
    ...
    <div className="min-h-screen bg-off-white font-dm selection:bg-navy/10 scroll-smooth">
            ...
            <div className="bg-navy-deeper rounded-[3rem] p-10 md:p-20 text-center relative overflow-hidden mt-20">
              ...
              <div className="relative z-10">
                ...
                <div className="pt-8 border-t border-white/10 text-[9px] font-black uppercase tracking-[0.5em] text-white/30">
                  © Cambridge International School Group | Compliance Division
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="py-12 text-center border-t border-sand/30">
        <p className="text-text-light text-[10px] font-black uppercase tracking-[0.2em]">
          Cambridge International School | Jaipur • Rajasthan • India
        </p>
      </footer>
    </div>
  );
