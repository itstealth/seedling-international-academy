...
const sections = [
  ...
  { id: "s5", title: "5. Website Availability", content: "While Seedling International School Group endeavors to keep the website accessible at all times, it reserves the right to suspend, restrict, or withdraw access to the website (in whole or in part) at any time without notice for operational, security, or administrative reasons." },
  ...
  { id: "s8", title: "8. Copyright", content: "All content on this website, including text, images, logos, and design, is protected by copyright and other intellectual property laws. Content may be viewed, printed, or downloaded solely for personal and non-commercial use. No material may be copied, modified, reproduced, published, or distributed without prior written permission from Seedling International School Group.", callout: "The name, logo, and trademarks of Seedling International School Group may not be used without express written authorization from the School." },
    ...
    <div className="min-h-screen bg-off-white font-dm selection:bg-navy/10 scroll-smooth">
      ...
      <footer className="py-12 text-center border-t border-sand/30">
        <p className="text-text-light text-[10px] font-black uppercase tracking-[0.2em]">
          Seedling International School | Jaipur • Rajasthan • India
        </p>
      </footer>
    </div>
  );
